...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#createActivityBtn").click(function () {
			...
			//初始化工作
			//重置表单
			$("#createActivityForm").get(0).reset();//$("#createActivityForm").[0]
			//任意js代码
		...
		$("#saveCreateActivityBtn").click(function () {
			...
			if (startDate!==""&&endDate!=="") {//使用自字符串的大小代替日期的大小来做比较
		...
		$(".mydate").datetimepicker({
			...
			minView:'month',//设置可以选择的最小视图
			initialDate:new Date(),//初始化现实的日期
			autoclose:true,//设置选择完日期或事件之后，是否自动关闭日历。
			todayBtn:true,//设置是否显示“今天”按钮，默认是false
			clearBtn:true,//设置是否显示“清空”按钮，默认是false
		});

		//当市场活动主页面加载完成，查询所有数据的第一页及所有数据的总条数，默认显示十条数据；
		...
		$("#chckAll").click(function () {
			...
			/*if (this.checked==true){
				//$("#tBody>input[type='checkbox']")//>括号代表获取父标签下的直接子标签
				$("#tBody input[type='checkbox']").prop("checkbox",true);//空格代表获取父标签下的所有子标签（直接和间接）
			}else{
				$("#tBody input[type='checkbox']").prop("checkbox",false);
				}*/
		...
		/*$("#tBody input[type='checkbox']").click(function () {
			...
			}else{$("#chckAll").prop("checked",false);
			}
		});*/
		...
		$("#deleteActivityBtn").click(function () {
			...
			var chekkedIds=$("#tBody input[type='checkbox']:checked");
			 ...
			 if(window.confirm("确定删除吗？")){
				 var ids="";
				 $.each(chekkedIds,function() {//id=xxx&id=xxx&...&id=xxx&
					 ids+="id="+this.value+"&";
				 });
